...
import { Eye, EyeOff, Mail, Lock, ArrowRight, Smartphone, TrendingUp, Shield } from 'lucide-react'
          ...
          <Card className="glass">
            ...
            <CardContent>
              ...
              <p className="mt-6 text-center text-sm text-gray-600">
                ...
                <Link href="/register" className="text-orange hover:text-orange-dark font-medium">
                  Sign up for free
                </Link>
              </p>
            </CardContent>
